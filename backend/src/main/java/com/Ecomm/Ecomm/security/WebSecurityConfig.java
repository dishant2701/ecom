package com.Ecomm.Ecomm.security;

import java.util.Arrays;

import com.Ecomm.Ecomm.security.filters.AuthHeaderFilter;
...
public class WebSecurityConfig {
  ...
  SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    ...
    // configuration.setAllowedOrigins(Arrays.asList("nctdelhi.pmgatishakti.gov.in"));
